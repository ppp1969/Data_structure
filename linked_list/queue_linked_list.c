...
보관할 data의 index 정보를 rear, 꺼낼 index 정보를 front라고 정의.
연결리스트를 이용하여 구현한 Queue에서는 보관할 때 rear 뒤에, 꺼낼 때는 front에 있는 것을 꺼냄.

큐에 자료를 보관하는 연산   	:	PUT or ENQUEUE
큐에 있는 자료를 꺼내는 연산 	:	GET or DEQUEUE

코드를 참조하고 공부한 사이트 : 	https://blog.naver.com/PostList.nhn?blogId=isaac7263&from=postList&categoryNo=41
							http://ehpub.co.kr/
*/
